...
inline constexpr const char* k_VK_EXT_SHADER_VIEWPORT_INDEX_LAYER_EXTENSION_NAME =
...
export {
    ...
    inline constexpr const char* VK_EXT_SHADER_VIEWPORT_INDEX_LAYER_EXTENSION_NAME =
        _wv_vk_ext::k_VK_EXT_SHADER_VIEWPORT_INDEX_LAYER_EXTENSION_NAME;
